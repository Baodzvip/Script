...
local LemonHubImageUI = Instance.new("ImageLabel")
        ...
        LemonHubScreen.Name = "LemonHubScreen"
        LemonHubScreen.Parent = game.CoreGui
        LemonHubScreen.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

        LemonHubToggleUI.Name = "LemonHubToggleUI"
        LemonHubToggleUI.Parent = LemonHubScreen
        LemonHubToggleUI.BackgroundColor3 = Color3.fromRGB(31,31,31)
        LemonHubToggleUI.BorderSizePixel = 0
        LemonHubToggleUI.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
        LemonHubToggleUI.Size = UDim2.new(0, 50, 0, 50)
        LemonHubToggleUI.Font = Enum.Font.SourceSans
        LemonHubToggleUI.Text = ""
        LemonHubToggleUI.TextColor3 = Color3.fromRGB(0, 0, 0)
        LemonHubToggleUI.TextSize = 14.000
        LemonHubToggleUI.Draggable = true
        LemonHubToggleUI.MouseButton1Click:Connect(function()
        game:GetService("VirtualInputManager"):SendKeyEvent(true, "LeftControl" , false , game)
        end)

        LemonHubCornerUI.Name = "LemonHubCornerUI"
        LemonHubCornerUI.Parent = LemonHubToggleUI

        LemonHubImageUI.Name = "MODILEMAGE"
        LemonHubImageUI.Parent = LemonHubToggleUI
        LemonHubImageUI.BackgroundColor3 = Color3.fromRGB(192,192,192)
        LemonHubImageUI.BackgroundTransparency = 1.000
